        ...
        if (data instanceof KnowledgeRecord) {
            if (data.getData() instanceof String) {
                ...
                try {
                    ...
                    // Extract necessary information out of the sensor data object
                    ...
                    // Add the retrieved data to the state management
                    ContextWrapper.getInstance().put(resourceId, sensorType, jsonData);

                    // Send the data to the Analyzer
