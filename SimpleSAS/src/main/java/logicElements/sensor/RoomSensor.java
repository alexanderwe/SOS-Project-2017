...
/**
 * Description from meta data: Test
 * 
 ...
 *
 */
public class RoomSensor extends AbstractLogic implements ISensorLogic {
	
	public RoomSensor() {
		super();	
		supportedInformationTypes.add(InformationType.DEFAULT);
	
		this.informationType = InformationType.DEFAULT;
		type = LogicType.SENSOR;
		shortName = "RoomSensor";
	}
